...
######################################################################
#PATH = os.getcwd()
#PATH2 = "C:/Users/KamKam/PycharmProjects/Test_streamlit/" # os.getcwd()+'/' # change for online app or local
...
with st.form(key='modele LGBM'):
    ...
    if st.form_submit_button(label='Résultat de la procédure'):
        ...
        st.markdown(f'**Score Remboursement = {round(proba0*100, 0)}/100**')




        discriminant = 0.47672201092439637
